...
import (
	...
	nginxcontrollerv1 "github.com/yp2800/crd-code-generation/pkg/apis/nginx_controller/v1"
	versioned "github.com/yp2800/crd-code-generation/pkg/client/clientset/versioned"
	internalinterfaces "github.com/yp2800/crd-code-generation/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/yp2800/crd-code-generation/pkg/client/listers/nginx_controller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MycompanyV1().Nginxes(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MycompanyV1().Nginxes(namespace).Watch(options)
			},
		},
